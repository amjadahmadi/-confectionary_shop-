...
//
//             <div class="d-flex flex-row-reverse m-2" style="height: 20%;"><p class="">ssdcds</p></div>
...
//        document.getElementById(element['id']).addEventListener('click',function (){window.location.href = `http://127.0.0.1:8000/product/detail/${element['id']}`;})
//     })
